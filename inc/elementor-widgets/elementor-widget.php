    ...
    final class Mosh_El_Widgets {
        ...
        public function enqueue_element_widgets_scripts() {
            ...
            ******************/
            ...
            wp_register_script( 'progress-loader-canvas', plugins_url( 'assets/js/progress-loader-canvas.js', __FILE__ ), array(), '1.0', true );
            // map active js
            wp_register_script( 'mosh-map-active', plugins_url( 'assets/js/map-active.js', __FILE__ ), array(), '1.0-s2', true );
            // mosh companion main js
            wp_enqueue_script( 'mosh-companion', plugins_url( 'assets/js/mosh-companion-main.js', __FILE__ ), array( 'masonry', 'mosh-ui-js' ), '1.0-s2', true );
