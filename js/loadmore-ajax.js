 ...
 * over admin-ajax into .mosh-portfolio-load and lays the Isotope grid out
        ...
        Array.prototype.forEach.call(loadbuttons, function (button) {
            button.addEventListener('click', function (e) {
                ...
                UI.request(portfolioloadajax.action_url, {
                    ...
                    UI.toElements('.mosh-portfolio-load').forEach(function (el) {
                        el.innerHTML = html;
                    });

                    UI.isotope('.mosh-portfolio', 'reloadItems');
                    UI.isotope('.mosh-portfolio', {
